...
PATH_RPCDEMO = rpcdemo
PATH_COMM = $(PATH_RPCDEMO)/common
PATH_NET = $(PATH_RPCDEMO)/net
PATH_TCP = $(PATH_RPCDEMO)/net/tcp
PATH_CODER = $(PATH_RPCDEMO)/net/coder
PATH_RPC = $(PATH_RPCDEMO)/net/rpc
...
CXXFLAGS += -I./ -I$(PATH_RPCDEMO)	-I$(PATH_COMM) -I$(PATH_NET) -I$(PATH_TCP) -I$(PATH_CODER) -I$(PATH_RPC)

LIBS += /lib/x86_64-linux-gnu/libprotobuf.a
...
$(LIB_OUT): $(COMM_OBJ) $(NET_OBJ) $(TCP_OBJ) $(CODER_OBJ) $(RPC_OBJ)
	cd $(PATH_OBJ) && ar rcv librpcdemo.a *.o && cp librpcdemo.a ../lib/
...
# to clean 
clean :
	rm -f $(COMM_OBJ) $(NET_OBJ) $(TESTCASES) $(TEST_CASE_OUT) $(PATH_LIB)/librpcdemo.a $(PATH_OBJ)/librpcdemo.a $(PATH_OBJ)/*.o
...
# uninstall
uninstall:
	rm -rf $(PATH_INSTALL_INC_ROOT)/rpcdemo && rm -f $(PATH_INSTALL_LIB_ROOT)/librpcdemo.a
...
#include "rpcdemo/common/msg_id_util.h"
#include "rpcdemo/common/error_code.h"
#include "rpcdemo/common/run_time.h"
...
void RpcChannel::CallMethod(const google::protobuf::MethodDescriptor* method,
  ...
  std::shared_ptr<rpcdemo::TinyPBProtocol> req_protocol = std::make_shared<rpcdemo::TinyPBProtocol>();
  ...
  m_client->connect([req_protocol, this]() mutable {
    ...
    getTcpClient()->writeMessage(req_protocol, [req_protocol, this, my_controller](AbstractProtocol::s_ptr) mutable {
      INFOLOG("%s | send rpc request success. call method name[%s], peer addr[%s], local addr[%s]", 
        ...
        std::shared_ptr<rpcdemo::TinyPBProtocol> rsp_protocol = std::dynamic_pointer_cast<rpcdemo::TinyPBProtocol>(msg);

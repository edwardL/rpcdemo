#ifndef RPCDEMO_NET_RPC_RPC_CHANNEL_H
#define RPCDEMO_NET_RPC_RPC_CHANNEL_H
...
#define NEWRPCCONTROLLER(var_name) \
  std::shared_ptr<rpcdemo::RpcController> var_name = std::make_shared<rpcdemo::RpcController>(); \

#define NEWRPCCHANNEL(addr, var_name) \
  std::shared_ptr<rpcdemo::RpcChannel> var_name = std::make_shared<rpcdemo::RpcChannel>(rpcdemo::RpcChannel::FindAddr(addr)); \

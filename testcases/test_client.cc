...
void test_tcp_client() {
  ...
  client.connect([addr, &client]() {
    ...
    client.writeMessage(message, [](rpcdemo::AbstractProtocol::s_ptr msg_ptr) {
      DEBUGLOG("send message success");
    });

    client.readMessage("123456789", [](rpcdemo::AbstractProtocol::s_ptr msg_ptr) {
